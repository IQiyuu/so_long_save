...
/*   Updated: 2022/11/26 21:40:42 by dgoubin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_way(t_graphconf *g_conf)
{
	...
	while (cpt++ < 1920)
	{
		...
		cpt2 = 0;
		if (g_conf->menu->unlocked_lvls - 7 > cpt/ 350 && cpt < 1800)
			while (cpt2 < 21)
